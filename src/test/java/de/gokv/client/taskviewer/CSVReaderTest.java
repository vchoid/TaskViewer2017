...
public class CSVReaderTest {
	...
	public void testCSVFileReaderException() {
		String wrongFile_path = System.getProperty("user.dir") + "/src/test/resources/falsche_famv_direct_input_monitoring_20170515131131.csv";
		readerValid = new CSVReader(wrongFile_path);
		try {
			readerValid.readCSVFile();
		} catch (ClientException e) {
			Assert.assertEquals("Datei " + wrongFile_path + " wurde nicht gefunden", e.getMessage());
