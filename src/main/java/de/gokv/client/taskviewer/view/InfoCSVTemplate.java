...
public class InfoCSVTemplate  extends PanelBlockTemplate{
	...
	public InfoField kvnr; 
	public InfoField name; 
	...
	protected InfoCSVTemplate(MyFrameController controller) {
		...
		// 1. Task ID
				...
				taskID_field.setFont(fontLabelText);
